...
const ENV_SOUND_MAP: Record<"rainforest" | "forest" | "ocean" | "campfire" | "snow" | "night" | "desert", string> = {
...
export function HeroOverlay() {
  ...
  const handleEnvChange = useCallback(async (id: EnvKey) => {
    const soundId = ENV_SOUND_MAP[id]
    if (!soundId) return
    ...
    if (activeEnv) await stopSound(ENV_SOUND_MAP[activeEnv])
          ...
          <div className="w-56">
            ...
            <div className="flex flex-col gap-1.5">
              {[
                ...
                const soundId = ENV_SOUND_MAP[env.id]
